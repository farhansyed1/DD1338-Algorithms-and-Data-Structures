...
public class TreeTest {
    ...
    public void insertIsTrueWhenElementIsNotInTree() {
        ...
        for (int elem : elementsNotInTree) {
            // Act
            boolean wasInserted = tree.insert(elem);
    ...
    public void searchIsTrueForInsertedElements() {
        ...
        for (int elem : elementsInTree) {
            // Act
            boolean wasFound = tree.search(elem);
    ...
    public void searchIsFalseWhenTreeIsEmpty() {
        ...
        // Act
        boolean wasFound = tree.search(1);
    ...
    public void leavesIsZeroWhenTreeIsEmpty() {
        Tree<Integer> tree = new Tree<>();
        assertThat(tree.leaves(), equalTo(0));
    ...
    public void leavesIsOneWhenTreeHasOnlyRoot() {
        Tree<Integer> tree = new Tree<>();
        tree.insert(1);
        assertThat(tree.leaves(), equalTo(1));
    ...
    public void leavesIsCorrectWhenTreeIsPerfect() {
        ...
        perfectTree.insert(15);
        perfectTree.insert(3);
        perfectTree.insert(7);
        perfectTree.insert(13);
        perfectTree.insert(17);

        assertThat(tree.leaves(), equalTo(n));
    }
    ...
    public void insertValuesInAscendingOrderIncrementsHeight() {
        ...
        Tree<Integer> tree = new Tree<>();
        int[] elementsInAscendingOrder = new int[] {2, 3, 4, 5, 6, 7, 8, 9};
        tree.insert(1);
        int expectedHeight = 0;
        for (int elem : elementsInAscendingOrder) {
            tree.insert(elem);
            expectedHeight++;

            assertThat(expectedHeight, equalTo(tree.height()));
        }
    }
